...
try {
  ...
  const future = run(dd, researchRoot, ["ulw-research", "record-evidence", "--session-id", "r1", "--claim-id", "c1", "--source-type", "official", "--url", "https://future.example", "--domain", "future.example", "--observer-group", "future", "--valid-at", "2999-01-01", "--locator", "x"]); assert.notEqual(future.status, 0, "future-dated evidence must be rejected");
