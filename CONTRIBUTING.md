...
For bug reports, feature requests, or questions, please open a [GitHub Issue](https://github.com/JeremyDev87/ddalggak/issues) first. Discuss in the issue before making code changes.
...
5. Codex와 Claude payload가 rendered evidence, analytics/privacy, knowledge extraction, self-created complexity guardrail, Quality Lens Router 같은 stable anchor를 유지합니다.
...
Maintainer: [@JeremyDev87](https://github.com/JeremyDev87)
