<!-- ddalggak:generated:file command-doc:gjc-execute -->
# Command: gjc-execute

Use when: GJC execute.
Required by: `gjc-execute` command.
Side effects: Approved edits; no GitHub.
...
```json
{
  ...
  "purpose": "GJC execute.",
  "mode": "source-edit",
  "write_side_effects": "Approved edits; no GitHub.",
  ...
  "required_templates": [],
  "output_contract": {
    "completion_signal": "GJC_EXECUTE_DONE",
    "evidence_required": true
  },
  "conditional_references": [],
  "conditional_templates": [],
  "allowed_artifact": "approved edits; no GitHub"
}
```
