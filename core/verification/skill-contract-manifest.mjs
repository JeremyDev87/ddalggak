...
export const subcommandExecutionContracts = {
  ...
  tune: {
    ...
    stopCondition: "goal-ready intent brief only; no source edits",
  },
  forge: {
    mode: "plan-only",
    sourceEditAllowed: false,
    ...
    stopCondition: "acceptance criteria only; no source edits",
  },
  spark: {
    mode: "plan-only",
    sourceEditAllowed: false,
    ...
    stopCondition: "runtime goal sentence only; no source edits",
  },
  check: {
    mode: "read-only",
    sourceEditAllowed: false,
